/*
 * Files: Combinations.cpp
 * ------------------------------------------------------
 * This program computes the mathematical function C(n,k)
 * from its mathematical definition in terms of factorials
 */
...
int main()
{
    ...
    cin >> n;
    cout << "Enter the number to be chosen: ";
    cin >> k;
