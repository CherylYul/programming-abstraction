 ...
 *       2
 *   a x   +   b x   +   c   =   0
 * If a is 0 or if the equation have no real roots, print
 ...
 * ------------------------------------------------------
 * Reads in the coefficients of a quadratic equations into
 ...
 * ------------------------------------------------------
 * Display roots of the quadratic equation x1, x2
 */
