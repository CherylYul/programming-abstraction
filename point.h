 ...
 * Usage: p1 != p2;
 * --------------------------------------------
 * This operator implements the != operator for points. It is good practice
 * to overload this operator whenever you overload == to ensure that clients
 * can perform either test.
 */
